        ...
        <div className="relative overflow-hidden mask-fade mb-12">
          ...
          <div className="flex gap-6 motion-safe:animate-scroll w-max items-center">
            {[...frameworks, ...frameworks].map((fw, index) => (
              ...
              >
                <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl p-2.5 flex items-center justify-center group-hover:scale-110 transition-all duration-300" style={{ background: "linear-gradient(145deg, hsl(225,42%,11%), hsl(225,42%,8%))", border: "1px solid rgba(255,255,255,0.09)" }}>
