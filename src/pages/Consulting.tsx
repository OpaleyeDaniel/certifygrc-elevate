...
const services = [
  {
    ...
    description: "Design, implement, and optimize IT service management practices aligned with industry best practices. We help organizations establish efficient service delivery models.",
  },
  {
    icon: Shield,
    title: "IT Governance",
    frameworks: ["COBIT 2019", "ISO 38500"],
    description: "Establish robust IT governance structures that align technology investments with business strategy and ensure accountability at every level.",
  },
  {
    icon: Lock,
    title: "Information & Cybersecurity",
    frameworks: ["NIST CSF", "ISO 27001", "SOC 2"],
    description: "Build comprehensive cybersecurity programs from risk assessment through implementation, certification, and continuous monitoring.",
  },
  {
    icon: RefreshCw,
    title: "Business Continuity",
    frameworks: ["BCI GPG", "ISO 22301"],
    description: "Develop and test business continuity and disaster recovery plans that ensure organizational resilience against disruptions.",
  },
  {
    icon: CreditCard,
    title: "Payment Security",
    frameworks: ["PCI DSS v4.0"],
    description: "Achieve and maintain PCI DSS compliance with expert guidance through scoping, gap analysis, remediation, and audit preparation.",
  },
  {
    icon: Eye,
    title: "Privacy & Data Protection",
    frameworks: ["PIPEDA", "NIST Privacy"],
    description: "Navigate complex privacy regulations with comprehensive data protection programs, impact assessments, and compliance roadmaps.",
  },
  {
    icon: Brain,
    title: "AI Governance",
    frameworks: ["NIST AI RMF", "ISO 42001"],
    description: "Implement responsible AI governance frameworks addressing bias, transparency, accountability, and regulatory compliance.",
  },
  {
    icon: Building2,
    title: "Enterprise Architecture",
    frameworks: ["TOGAF", "Zachman"],
    description: "Design and implement enterprise architecture programs that drive digital transformation and technology modernization.",
  },
  {
    icon: Zap,
    title: "Agile Project Management",
    frameworks: ["Scrum", "SAFe", "PMI"],
    description: "Transform project delivery with agile methodologies scaled for enterprise environments.",
  },
  {
    icon: Landmark,
    title: "OSFI Compliance",
    frameworks: ["B-13", "B-10", "E-21"],
    description: "Specialized consulting for Canadian financial institutions navigating OSFI regulatory requirements.",
  },
];
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, i) => (
              <button
                ...
                className="text-left group glass rounded-xl p-6 hover-lift hover-glow transition-all animate-fade-in"
