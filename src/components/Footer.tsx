...
const footerLinks = {
  ...
  Compare: [
    { label: "Vanta & Drata Alternative", path: "/compare" },
    { label: "CertifyGRC vs. Vanta", path: "/compare/vanta-alternative" },
    { label: "CertifyGRC vs. Drata", path: "/compare/drata-alternative" },
