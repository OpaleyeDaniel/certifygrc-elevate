  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover": "0 1px 0 rgba(255,255,255,0.06) inset, 0 4px 8px rgba(0,0,0,0.6), 0 20px 50px -16px rgba(48,92,222,0.22), 0 0 0 1px rgba(48,92,222,0.06)",
        "card-featured": "0 1px 0 rgba(255,255,255,0.05) inset, 0 8px 24px -8px rgba(48,92,222,0.18), 0 0 0 1px rgba(48,92,222,0.08)",
      },
    },
  },
