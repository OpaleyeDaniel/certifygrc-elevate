...
export function createSoftwareApplicationSchema() {
  return {
    ...
    featureList: [
      ...
      "Automated Cybersecurity Gap Analysis & Maturity Scoring",
      "ISO/IEC 27001:2022 ISMS & Automated Statement of Applicability (SoA)",
      "SOC 2 Type I & Type II Continuous Control Monitoring",
      "CyberDrill Employee Phishing Simulations & Tabletop Drills",
      "Unified Multi-Framework Control Deduplication (Test Once, Comply Everywhere)",
      "Integrated vCISO Strategic Advisory & Audit Defense Representation",
    ],
    knowsAbout: [
      "NIST Cybersecurity Framework 2.0 (NIST CSF 2.0)",
      "ISO/IEC 27001:2022 Information Security Management",
      "SOC 2 Type I & Type II Trust Services Criteria",
      "OSFI Guidelines B-10 & B-13",
      "PCI DSS 4.0",
      "ISO/IEC 42001 Artificial Intelligence Management System",
      "HIPAA Security & Privacy Rules",
      "Continuous Compliance Automation",
      "Cybersecurity Governance & Risk Registers",
