...
.h{background:linear-gradient(135deg,#305CDE,#5B7FE8);padding:28px 32px}
...
.tag{background:#ede9fe;color:#305CDE;border-radius:6px;padding:3px 9px;font-size:12px;font-weight:600}
...
<style>body{font-family:Arial,sans-serif;background:#f5f7fa;margin:0;padding:0}
.w{max-width:600px;margin:40px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.08)}
.h{background:linear-gradient(135deg,#305CDE,#5B7FE8);padding:32px;text-align:center}
...
.hl{background:#ede9fe;border-radius:8px;padding:14px 18px;color:#305CDE;font-size:14px;font-weight:600;margin:18px 0}
.cta{display:inline-block;background:linear-gradient(135deg,#305CDE,#5B7FE8);color:#fff;text-decoration:none;border-radius:8px;padding:11px 26px;font-size:15px;font-weight:600;margin-top:6px}
...
<p>In the meantime feel free to explore our platform or email us at <a href="mailto:info@certifygrc.com" style="color:#305CDE">info@certifygrc.com</a>.</p>
...
<p>If it's urgent you can reach us at <a href="mailto:info@certifygrc.com" style="color:#305CDE">info@certifygrc.com</a>.</p>
