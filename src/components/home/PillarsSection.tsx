...
const pillars = [
  {
    ...
    link: "/software",
    features: ["NIST CSF 2.0", "PCI DSS", "PIPEDA"],
    gradient: "from-primary/20 to-primary/5",
  },
  {
    icon: Users,
    title: "Consulting Services",
    description: "We help organizations strengthen business continuity, cybersecurity, and regulatory compliance — so they can operate confidently and scale sustainably.",
    link: "/consulting",
    features: ["ISO 27001", "SOC 2", "COBIT"],
    gradient: "from-accent/20 to-accent/5",
  },
  {
    icon: GraduationCap,
    title: "E-Learning",
    description: "Professional development and certification programs to build GRC competency across your entire organization — from foundational to advanced.",
    link: "/e-learning",
